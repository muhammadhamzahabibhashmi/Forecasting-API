...
if genre == 'Train':
    ...
    if uploaded_file is not None:
        ...
        if st.sidebar.button('Train'):
            ...
            resspoon = requests.post(url="http://20.29.120.236/train/", json=payyl)
    ...
    if st.sidebar.button('Check Status Of Training'):
        payload2 = {"UserID":"245"}
        asd2=requests.post(url="http://20.29.120.236/Checktrain/", json=payload2)
    ...
    try:
        ...
        if len(newListOfUsersModelsmodelss) > 0:
            ...
            if st.sidebar.button('Predictions'):
                ...
                asd=requests.post(url="http://20.29.120.236/detect/", json=payyl)
